...
//You can also take part of a class or struct if only a limited numfber of members are to be set. You do this by changing size and making sure the variables wanted are inline
